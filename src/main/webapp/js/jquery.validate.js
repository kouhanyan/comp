 ...
 *
 * $Id: jquery.validate.js,v 1.1 2010/04/21 02:30:07 mcy Exp $
 *
			...
			.extend(
					$.validator,
					{
						...
						methods : {
							...
							checkTel : function(value, element, param) {
								if (value == '')
									return true;
								return /^[0-9\+(\s]{3,}[0-9\-)\s]{2,}[0-9]$/
										.test(value) ? true : false;
							},
							byteRange : function(value, element, param) {
								...
								return this.optional(element)
										|| ((param[0] == '' || length >= param[0]) && (param[1] == '' || length <= param[1]));
							},

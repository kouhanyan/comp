(function(a) {
    a.fn.slides = function(b) {
        ...
        this.each(function() {
            ...
            b.generateNextPrev && (a("." + b.container, c).after('<a href="#" class="' + b.prev + '"><span>Prev</span></a>'), a("." + b.prev, c).after('<a href="#" class="' + b.next + '"><span>Next</span></a>')),
            ...
            b.generatePagination ? (b.prependPagination ? c.prepend("<div class=" + b.dtnavClass + "><ul class=" + b.paginationClass + "></ul></div>") : c.append("<div class=" + b.dtnavClass + "><ul class=" + b.paginationClass + "></ul></div>"), d.children().each(function() {

...
<body>
	<form action="${pageContext.request.contextPath}/comp/sysVersion/edit"
		method="post" id="formId">
		<input type="hidden" name="id" value="${sysVersion.id}">
		<div class="main">
			<div class="path">
				<div class="path_left"></div>
				<div class="path_module">当前位置：系统管理 → 版次管理 →版次修改</div>
				<div ></div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="left"><input name="edition" type="text"
									value="${sysVersion.edition }" id="edition"/><span style="color: red" id="editionInfo">*</span></td>
							</tr>
							<tr>
								<th align="right">目次：</th>
								<td align="left"><input name="directory" type="text"
									value="${sysVersion.directory }" id="directory">
									<span style="color: red" id="directoryInfo">*</span></td>
							</tr>

							<tr>
								<th align="right">特点：</th>
								<td align="left"><textarea name="characteristic">${sysVersion.characteristic}</textarea></td>
							</tr>
							<tr>
								<th align="right">版本说明：</th>
								<td align="left"><textarea name="releaseNotes">${sysVersion.releaseNotes}</textarea></td>
							</tr>

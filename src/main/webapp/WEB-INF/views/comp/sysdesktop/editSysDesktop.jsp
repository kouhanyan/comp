...
<script type="text/javascript">
	function judgeSubmit() {
		...
		if (file != '' && file.indexOf(".png") < 0 && file.indexOf(".ico") < 0
				&& file.indexOf(".icns") < 0 && file.indexOf(".jpg")<0) {
...
<body>
	...
	<form action="${pageContext.request.contextPath}/comp/sysDesktop/edit"
		method="post" id="formId" enctype="multipart/form-data">
		<input type="hidden" name="id" value="${sysDesktop.id}">
		<div class="main">
			<div class="path">
				<div class="path_left"></div>
				<div class="path_module">当前位置：系统管理 → 系统桌面管理→ 系统桌面修改</div>
				<div ></div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td align="left"><input type="hidden" name="url"
									value="${sysDesktop.url}" />${sysDesktop.url}&nbsp;</td>
							</tr>

							<tr>
								<th align="right">选择图标：</th>
								<td align="left"><input id="file" type="file" name="file" style="width:150px;" /><span
									style="color: red" id="fileInfo">*</span></td>
							</tr>

							<tr>
								<th align="right">当前图标：</th>
								<td align="left"><img alt="桌面图标"
									src="${pageContext.request.contextPath}/comp/sysDesktop/icos/${sysDesktop.id}"></td>
							</tr>

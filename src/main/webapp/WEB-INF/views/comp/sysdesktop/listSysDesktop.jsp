...
<body>
	<form action="${pageContext.request.contextPath}/comp/sysDesktop/list"
		method="post" id="formId">
		<jsp:include page="/includes/writeHidden.jsp" flush="true" />
		<div class="main">
			<div class="path">
				<div class="path_left"></div>
				<div class="path_module">当前位置：系统管理 → 系统桌面管理→ 系统桌面列表</div>
			...
			<div class="main_content">
				...
				<div class="search">
					<div class="search_condition">
						<span><font>图标名称：</font> <input name="name" type="text" value="${sysDesktopQueryForm.name}"/>
						</span> 
							<span class="search_button"
							onclick="doFormSubmit('formId','${pageContext.request.contextPath}/comp/sysDesktop/query')">
				...
				<div class="list_table_title">
					...
					<ul>
						<li><span class="btn_left"></span><a
							href="${pageContext.request.contextPath}/comp/sysDesktop/addForward"
							class="btn btn_new">新增</a><span class="btn_right"></span></li>
						<li><font></font></li>
						<li><span class="btn_left"></span><a
							href="javascript:modfiy('${pageContext.request.contextPath}/comp/sysDesktop/findOne/#id#')"
							class="btn btn_edit">修改</a><span class="btn_right"></span></li>
						<li><font></font></li>
						<li><span class="btn_left"></span><a
							href="javascript:remove('${pageContext.request.contextPath}/comp/sysDesktop/delete/#id#')"

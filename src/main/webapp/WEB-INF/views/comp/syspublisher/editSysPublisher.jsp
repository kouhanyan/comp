...
<body>
	...
	<form action="${pageContext.request.contextPath}/comp/sysPublisher/edit"
		method="post" id="formId">
		<input type="hidden" name="id" value="${sysPublisher.id}">
		<div class="main">
			<div class="path">
				<div class="path_left"></div>
				<div class="path_module">当前位置：系统管理 → 出版社管理→ 出版社修改 </div>
				<div ></div>

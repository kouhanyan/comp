...
<body>
	<form action="${pageContext.request.contextPath}/comp/sysRegion/edit"
		method="post" id="formId">
		<input type="hidden" name="id" value="${sysRegion.id}">
		<div class="main">
			<div class="path">
				<div class="path_left"></div>
				<div class="path_module">当前位置：系统管理 → 行政区划管理→ 行政区划修改</div>
				<div ></div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="left"><input name="code" type="text"
									value="${sysRegion.code}" id="code"/><span style="color: red" id="codeInfo">*</span></td>
							</tr>
							<tr>
								<th align="right">行政区划名称：</th>
								<td align="left"><input name="name" type="text"
									value="${sysRegion.name}" id="name"/><span style="color: red" id="nameInfo">*</span></td>
							</tr>

							<tr>
								<th align="right">行政区划等级：</th>
								<td align="left"><input name="regionLevel" type="text"
									value="${sysRegion.regionLevel}" id="level" /><span style="color: red" id="levelInfo">*</span></td>
							</tr>

...
<body>
	...
	<form action="${pageContext.request.contextPath}/comp/sysResource/add"
		method="post" id="formId" enctype="multipart/form-data">
		<div class="main">
			<div class="path">
				<div class="path_left"></div>
				<div class="path_module">当前位置：系统管理 → 系统资源管理→ 系统资源添加 </div>
				<div ></div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td align="left"><input name="resourceLevel" type="text"
									value="" id="level" onblur="findByLevel()"/><span

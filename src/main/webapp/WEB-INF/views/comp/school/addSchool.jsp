...
<script type="text/javascript">
	function getRegion(){
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/comp/school/getRegion",
			type : "POST",
			dataType : "json",
			data : {
			...
			success : function(data) {
				if(data != null){
					...
					for(index in data){
						$("#regionId").append('<option value="'+data[index].id+'">'+data[index].name+'</option>');
					}
				}
			}
		});
...
<body>
	<form action="${pageContext.request.contextPath}/comp/school/add"
		method="post" id="formId">
		<div class="main">
			<div class="path">
				<div class="path_left"></div>
				<div class="path_module">当前位置：系统管理 → 学校管理 → 学校添加</div>
				<div ></div>
					...
					<div class="row_half_right">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="left"><input id="schoolCode" name="schoolCode" type="text" onblur ="getRegion();"
							...
							<tr>
								...
								<td align="left"><select name="sysRegion.id" id="regionId">
							...
							<tr>
								...
								<td><input name=""
									...
									onclick="doFormSubmit('formId','${pageContext.request.contextPath}/comp/school/add')" />

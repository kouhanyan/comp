...
<body>
	...
	<form action="${pageContext.request.contextPath}/comp/sysAnnouncement/add"
		method="post" id="formId">
		<div class="main">
			<div class="path">
				<div class="path_left"></div>
				<div class="path_module">当前位置：系统管理 → 系统公告管理→ 系统公告添加</div>
				<div ></div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td align="left"><textarea name="content"
										id="content" cols="50" rows="3"></textarea><span

...
<body>
	...
	<form action="${pageContext.request.contextPath}/comp/biblioAuthorize/edit"
		method="post" id="formId">
		<input type="hidden" name="id" value="${biblioAuthorize.id}"> 
		<input type="hidden" name="curCount" value="${biblioAuthorize.curCount}"> 
		<div class="main">
			<div class="path">
				<div class="path_left"></div>
				<div class="path_module">当前位置：系统管理 → 编目授权管理→ 编目授权修改 </div>
				<div ></div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td align="left"><input name="applicant" type="text"
									value="${biblioAuthorize.applicant}" id="applicant" /><span
							...
							<tr>
								...
								<td align="left"><input name="appCount" type="text"
									value="${biblioAuthorize.appCount}" id="appCount" /><span
